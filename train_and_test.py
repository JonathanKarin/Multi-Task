...
def main():
    ...
    max_pool_long = MaxPooling1D(pool_size=(40 - params_dict["filters_long_length"]))(conv_kernel_long)
    max_pool_11 = MaxPooling1D(pool_size=(31))(conv_kernel_11)
    max_pool_9 = MaxPooling1D(pool_size=(33))(conv_kernel_9)
    max_pool_7 = MaxPooling1D(pool_size=(35))(conv_kernel_7)
    max_pool_5 = MaxPooling1D(pool_size=(37))(conv_kernel_5)
    max_pool_5_sec = MaxPooling1D(pool_size=(37))(conv_kernel_5_sec)
